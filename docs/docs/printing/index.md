...
- Endpoint - `api/v1/printing/products` |
...
- Endpoint - `http://localhost:4000/api/v1/printing/orders` |
...
```json
{
    ...
    "order": {
        ...
        "orderId": "ORDER-printing-1776963335498-8405",
...
- endpoint: `http://localhost:4000/api/v1/printing/products/`
...
- endpoint: `http://localhost:4000/api/v1/printing/products/search?name=mnyonyo`
...
- endpoint: `http://localhost:4000/API/v1/printing/products/:id`
`http://localhost:4000/api/v1/printing/products/69ea4db7169f2fe4afe65792`
...
- endpoint: `http://localhost:4000/API/v1/printing/orders/search`

`http://localhost:4000/API/v1/printing/orders/search?"orderId=ORDER-printing-1776964623743-9090"`
- response body: 
...
- endpoint: `http://localhost:4000/API/v1/printing/orders/:id`

`http://localhost:4000/api/v1/printing/orders/69ea540fa9385304bfbbc884`
...
```json
{
    ...
    "price": 23000,
    "total": 23000,
    "orderId": "ORDER-printing-1776964623743-9090",
...
- endpoint: `http://localhost:4000/API/v1/printing/available-products`
...
- endpoint: `http://localhost:4000/api/v1/printing/revenue?period=day`
...
- endpoint: `http://localhost:4000/api/v1/printing/total-orders?filter=week`
...
- endpoint: `http://localhost:4000/api/v1/printing/reports?startDate=2025-01-01&endDate=2026-10-31`

## Orders Count

- endpoint: `http://localhost:4000/api/v1/printing/orders-count`
- response body: 
```json
{
    "totalCount": 3
...
- endpoint: `http://localhost:4000/api/v1/printing/products-count`
- response body: 
```json
{"totalProducts":1550}
```
...
- endpoint: `http://localhost:4000/api/v1/printing/sales-total`
- response body: 
```json
{"totalSales":215000}
```
...
- endpoint: `http://localhost:4000/api/v1/printing/products/:id`
    `http://localhost:4000/api/v1/printing/products/69ea4e965fb2f565b07b25de`
- request body:
...
- endpoint: `http://localhost:4000/api/v1/printing/orders/:id`
- request body: `http://localhost:4000/api/v1/printing/orders/69ea540fa9385304bfbbc884`
...
- endpoint: `http://localhost:4000/api/v1/printing/order/:id`
`http://localhost:4000/api/v1/printing/order/69e7c1327a501a5133538ebf`
- response:
