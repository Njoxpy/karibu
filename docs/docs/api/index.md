...
backend on `http://localhost:4000`. All endpoints are prefixed with
`/api/v1/<module>`.
...
|-----------------|-----------------------------|-------------------------------------------|
| Users           | `/api/v1/users`             | [Users](users.md)                         |
| Animal Feeding  | `/api/v1/animal-feeding`    | [Animal Feeding](animal-feeding.md)       |
| Fresh Oil       | `/api/v1/fresh-oil`         | [Fresh Oil](fresh-oil.md)                 |
| Godown          | `/api/v1/godown`            | [Godown](godown.md)                       |
| Hardware        | `/api/v1/hardware`          | [Hardware](hardware.md)                   |
| Printing        | `/api/v1/printing`          | [Printing](printing.md)                   |
| Stationery      | `/api/v1/stationery`        | [Stationery](stationery.md)               |
