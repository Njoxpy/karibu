...
const addHeader = (doc, colors) => {
  ...
  doc
    ...
    .fontSize(22)
    .font("Helvetica-Bold")
    .text("GODOWN SALES REPORT", 50, 54, { align: "center" })
    .moveDown(2);
};
...
const addTableRow = (
  ...
  if (index % 2 === 0) {
    doc
      .rect(orderIdX, yPosition, 500, 25)
      .fillColor(colors.accent)
      .fillOpacity(0.5)
      .fill()
      .fillOpacity(1);
  ...
  // Order ID
  doc.text(order.productName || "N/A", orderIdX + 10, yPosition + 8, {
    width: 300,
    align: "left",
  });
