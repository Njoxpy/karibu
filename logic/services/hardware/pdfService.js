...
const generateHardwarePDF = (orders, res) => {
  try {
    ...
    const doc = new PDFDocument({
      ...
      autoFirstPage: true,
      info: {
        Title: `Hardware Sales Report - ${moment().format("YYYY-MM-DD")}`,
        Author: "Hardware Management System",
        Subject: "Sales Report",
        Keywords: "hardware, sales, report",
    ...
    const colors = {
      ...
      highlight: "#93c5fd", // Medium light blue for highlights
...
const addHeader = (doc, colors) => {
  ...
  doc
    ...
    .fontSize(22)
    .font("Helvetica-Bold")
    .text("HARDWARE SALES REPORT", 50, 54, { align: "center" })
    .moveDown(2);
};
