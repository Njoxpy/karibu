        ...
        <>
            <div className="p-6 bg-gray-50 min-h-screen">
                ...
                <div className="border-2 border-dashed border-yellow-400 bg-yellow-50 p-6 rounded-lg flex flex-col items-center justify-center mb-6">
                    ...
                    <label
                        htmlFor="file-input"
                        className="cursor-pointer text-yellow-500 text-lg font-medium py-2 px-4 border border-yellow-400 rounded-md hover:bg-yellow-100"
                    >
...
export default BulkUploadFreshOil;
