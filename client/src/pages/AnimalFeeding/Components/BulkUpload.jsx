...
function BulkUpload() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      {/* Upload Zone */}
      <div className="border-2 border-dashed border-green-400 bg-green-50 p-6 rounded-lg flex flex-col items-center justify-center mb-6">
        <input
          type="file"
          accept=".csv,.xlsx"
          id="file-input"
        ...
        <label
          htmlFor="file-input"
          className="cursor-pointer text-green-500 text-lg font-medium py-2 px-4 border border-green-400 rounded-md hover:bg-green-100"
        >
