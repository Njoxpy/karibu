...
const StationeryItemDetails = () => {
  ...
  const product = {
    id: 1,
    name: "Exercises Books",
    price: 2300,
    description: "High quality msomi books.",
    ...
    <>
      <div className="flex flex-col items-center p-4 bg-green-50">
        ...
        <div className="mt-4 flex items-center">
          ...
          />
          <button className="bg-green-500 text-white py-2 px-4 rounded transition duration-300 hover:bg-green-600">
            Add to Cart
          </button>
        </div>
      </div>
